...
from controller.Recursive_FNTSMC import recursive_fntsmc_param, recursive_fntsmc
...
att_ctrl_param = recursive_fntsmc_param()
...
if __name__ == '__main__':
    uav = UAV(uav_param)
    ctrl_in = recursive_fntsmc(att_ctrl_param)
